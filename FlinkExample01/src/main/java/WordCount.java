...
//        DataStream<String> stream = env.socketTextStream("192.168.137.131",9999);
//        map操作
//        这里使用的flatmap方法
//        map：针对流中的每一个元素，输出一个元素
//        flatmap：针对流中的每一个元素，输出0个，或者多个元素
        SingleOutputStreamOperator<WordWithCount> mappenStream = stream
...
//        分组：shuffle
        KeyedStream<WordWithCount, String> keyedStream = mappenStream
//                第一个泛型：流中元素的泛型
//                第二个泛型：key的泛型
