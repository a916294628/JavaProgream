...
public class Demo4_SqlTableCreate {
    public static void main(String[] args) {
        ...
        //一、通过构建一个TableDesctiptor 来构建一个“有名”表 sql表
        tenv.createTable("table_a",
                TableDescriptor.forConnector("filesystem")
                        .schema(Schema.newBuilder()
                                ...
                                .build())
                        .format("csv")
                        .option("path","file:///G:\\JavaProgram\\flink_duoyi_example\\data\\sqldemo\\a.txt")
...
//        Table table_a = tenv.from("table_a");
        ...
        tenv.executeSql("select gender,max(age) as max_age from table_e group by gender")/*.print()*/;

        //二、从一个datastream上创建“有名”的视图
        DataStreamSource<String> stream1 = env.socketTextStream("hadoop01", 9999);
